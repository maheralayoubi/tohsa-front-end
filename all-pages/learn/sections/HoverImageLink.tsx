...
function HoverImageLink({
  ...
  return (
    <div
      className="flex justify-between cursor-pointer p-1 rounded-lg hover:bg-[#00A7D3] hover:text-white transition"
    ...
    >
      ...
      <Image src={defaultImage} alt="arrow" width={24} height={24} />
    </div>
  );
}
