    ...
    return (
        <section className="py-10 px-5 lg:py-32 lg:px-10 max-w-[920px] text-[#111118] space-y-10 lg:space-y-20 mx-auto text-xs lg:text-2xl font-normal">
            ...
            <table className="border-collapse border border-[#878787]">
                <tbody>
                    <TableRow rowTitle={"Date & Time"} rowContent={data?.dateTime} />
                    <TableRow rowTitle={"Place"} rowContent={data?.place} />
                    <TableRow rowTitle={"Rigester For"} rowContent={data?.rigesterFor} />
                    <TableRow rowTitle={"Program"}>
