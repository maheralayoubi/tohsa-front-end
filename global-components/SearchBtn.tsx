...
const SearchBtn = () => {
    ...
    return (
        <div className="flex items-center justify-end lg:justify-start gap-2 flex-1 lg:mx-10">
            ...
            <Link
                href={`/search?q=${query}`}
                onClick={() => setQuery("")}
                className="lg:p-2 lg:bg-[#57369E] lg:hover:bg-[#00A7D3] transition-colors duration-500"
            >
