    ...
    return (
        <Link href={`/news/${data?.id}`}>
            <div className="flex flex-col sm:flex-row items-start justify-between p-5 gap-5 bg-[#F0F5FF] rounded-lg">
                <div className="relative w-full sm:w-[160px] sm:h-[120px] xl:w-[262px] h-[180px] xl:h-[196px] bg-black">
                ...
                <div className="flex-1 space-y-5 text-left relative h-full">
                    <h2 className="line-clamp-1 lg:line-clamp-2 font-bold xl:text-xl">{data.title}</h2>
                    <p className="line-clamp-1 text-base sm:text-xs xl:text-base xl:line-clamp-3">{data.content1}</p>
