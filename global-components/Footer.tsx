  ...
  return (
    <section className="border-t border-[#484848] text-[#111118] font-normal text-xs lg:text-base p-4 lg:px-5 lg:py-10 space-y-10 flex items-center justify-center flex-col">
      ...
      <div className="flex flex-wrap items-center justify-center max-w-5xl gap-x-5 gap-y-10 lg:gap-x-10 lg:gap-y-20">
        <Link
          href="/"
          className="relative lg:scale-100 w-[120px] h-[20px] lg:w-[270px] lg:h-[45px]"
        >
          <Image src="/images/footer1.png" alt="footer1" fill />
        </Link>
        <Link
          href="/"
          className="relative lg:scale-100 w-[110px] h-[40px] lg:w-[220px] lg:h-[80px]"
        >
          <Image src="/images/footer2.png" alt="footer2" fill />
        </Link>
        <Link
          href="/"
          className="relative lg:scale-100 w-[65px] h-[40px] lg:w-[130px] lg:h-[80px]"
        >
          <Image src="/images/footer5.png" alt="footer5" fill />
        </Link>
        <Link
          href="/"
          className="relative lg:scale-100 w-[120px] h-[18px]  lg:w-[373px] lg:h-[58px]"
        >
          <Image src="/images/footer3.png" alt="footer3" fill />
        </Link>
        <Link
          href="/"
          className="relative lg:scale-100 w-[120px] h-[18px] lg:w-[300px] lg:h-[44px]"
        >
        ...
        <Link
          href="/"
          className="relative lg:scale-100 w-[44px] h-[40px] lg:w-[88px] lg:h-[80px]"
        >
      ...
      <div className="flex items-center justify-center gap-1 max-w-5xl">
        <p>Version 1.2 - </p>
        <Link className="text-[#57369E]" href={"/"} target="_blanck">
          {" "}
